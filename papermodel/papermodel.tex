%%中山大学物理学院-基础物理实验-论文格式报告模板
%%启动整理日期：2020/2/13
%%完成整理日期：2020/2/18
%%中山大学物理学院18级 王佛泓
%%文本编辑器：Sublime Text
%%平台环境：win10；Tex live 2019
...
\usepackage{CJK,CJKnumb,amsmath,paralist,enumerate,booktabs,multirow,graphicx,float,subfig,setspace,listings}
	%CJK，CJKnumb：更多中文字体（如楷体，作者和机构需要用到）支持
	%amsmath：数学公式
...
\usepackage{titlesec}
	...
	\newCJKfontfamily\sectioncf{SimHei}
