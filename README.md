...
- papermodel&reportmodel 中图片排版的彻底完善: 从较老的subfigure宏包完全迁移到了[subfig宏包](https://www.ctan.org/pkg/subfig), 可以实现图片的并行排版, 竖向排版, $2\times2$ 排版, 等等, 读者可以根据模板中的三个例子举一反三. 
- 中文字体部分代码默认注释, 读者理论上可以直接编译使用.
- 模板行文上的小修改
...
<img src="https://github.com/wangfh5/sysu-sop-latexmodel/blob/master/Typora_Picture/README/image-20201001152208858.png" alt="image-20201001152208858" style="zoom:80%;" />
